...
//==============================================================
			case RK_FUN_1: {
				fun_to_exec = eff_fala;
				coursor_mode = mode_fala;
				break;
			}
			case RK_FUN_2: {
				fun_to_exec = eff_rand;
				coursor_mode = mode_rand;
				break;
			}
			case RK_FUN_3: {
				fun_to_exec = eff_strobo;
				coursor_mode = mode_null;
				break;
			}
			case RK_FUN_4: {
				fun_to_exec = eff_xmas;
				coursor_mode = mode_xmas;
				break;
			}
...
//==============================================================
			case RK_RED: {
				...
				coursor_mode = mode_red;
				break;
			}
			case RK_GREEN: {
				fun_to_exec = eff_null;
				coursor_mode = mode_green;
				break;
			}
			case RK_BLUE: {
				fun_to_exec = eff_null;
				coursor_mode = mode_blue;
				break;
			}
			case RK_YELLOW: {
				fun_to_exec = eff_null;
				coursor_mode = mode_lightness;
				RGB_save();
				break;
			}
